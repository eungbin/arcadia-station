...
/**
 * 5장 계약(POST {AI_SERVER_BASE_URL}/api/v1/sessions/{sessionId}/interrogations/{characterId}/turns)의 실제 구현체.
 */
@Component
@Profile("real-ai")
    ...
    public NpcTurnResult ask(String sessionId, String characterId, String question, List<String> presentedClueIds) {
        try {
            return restClient.post()
                    .uri("/api/v1/sessions/{sessionId}/interrogations/{characterId}/turns", sessionId, characterId)
            ...
            throw new AiSessionLostException("Interrogation session not found: " + sessionId);
        }
    }
